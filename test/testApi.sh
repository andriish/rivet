...
RIVET_BUILDPLUGIN_BEFORE_INSTALL=1 bash ../bin/rivet-build ../analyses/pluginMC/EXAMPLE.cc ../analyses/pluginMC/MC_JETS.cc ../analyses/pluginMC/EXAMPLE_CUTS.cc ../analyses/pluginMC/EXAMPLE_SMEAR.cc -I../include
