...
#endif
{
  public:
    ...
    typedef RivetEigen::Map<Derived, Unaligned>  MapType;
    typedef const RivetEigen::Map<const Derived, Unaligned> ConstMapType;
    typedef RivetEigen::Map<Derived, AlignedMax> AlignedMapType;
    typedef const RivetEigen::Map<const Derived, AlignedMax> ConstAlignedMapType;
    template<typename StrideType> struct StridedMapType { typedef RivetEigen::Map<Derived, Unaligned, StrideType> type; };
    template<typename StrideType> struct StridedConstMapType { typedef RivetEigen::Map<const Derived, Unaligned, StrideType> type; };
    template<typename StrideType> struct StridedAlignedMapType { typedef RivetEigen::Map<Derived, AlignedMax, StrideType> type; };
    template<typename StrideType> struct StridedConstAlignedMapType { typedef RivetEigen::Map<const Derived, AlignedMax, StrideType> type; };
...
//       EIGEN_INITIALIZE_COEFFS_IF_THAT_OPTION_IS_ENABLED
  ...
  public:
    ...
    // Map symbol.
    template<typename PlainObjectType, int MapOptions, typename StrideType> friend class RivetEigen::Map;
    friend class RivetEigen::Map<Derived, Unaligned>;
    friend class RivetEigen::Map<const Derived, Unaligned>;
#if EIGEN_MAX_ALIGN_BYTES>0
    // for EIGEN_MAX_ALIGN_BYTES==0, AlignedMax==Unaligned, and many compilers generate warnings for friend-ing a class twice.
    friend class RivetEigen::Map<Derived, AlignedMax>;
    friend class RivetEigen::Map<const Derived, AlignedMax>;
#endif
};
