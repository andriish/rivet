...
using namespace fastjet;
  ...
  class HTT : public Projection
  {
    ...
    public:
        ...
        HTT(const JetAlg& jetalg) : _do_optimalR(1), _do_qjets(0),
                                   _mass_drop_threshold(0.8), _max_subjet_mass(30.),
                                   set_mode(4), _mtmass(172.3), _mwmass(80.4), _fw(0.15),
                                   ...
                                   _nfilt(5), _Rfilt(0.3), _filtering_jetalg(fastjet::cambridge_algorithm), 
                                   _minpt_subjet(0.), _reclustering_jetalg(fastjet::cambridge_algorithm),
