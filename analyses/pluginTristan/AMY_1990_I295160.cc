...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      declare(cfs, "CFS");
      int offset = 0;
      if (beamEnergyMatch(50.0)) offset = 1;
      else if(beamEnergyMatch(52.0)) offset = 2;
      else if(beamEnergyMatch(55.0)) offset = 3;
      else if(beamEnergyMatch(56.0)) offset = 4;
      else if(beamEnergyMatch(57.0)) offset = 5;
      else if(beamEnergyMatch(60.0)) offset = 6;
      else if(beamEnergyMatch(60.8)) offset = 7;
      else if(beamEnergyMatch(61.4)) offset = 8;
