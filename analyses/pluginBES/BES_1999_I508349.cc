...
namespace Rivet {
  ...
  /// @brief Charm cross sections from BES
  class BES_1999_I508349 : public Analysis {
  public:

    /// Constructor
    DEFAULT_RIVET_ANALYSIS_CTOR(BES_1999_I508349);
    ...
    void init() {
      ...
      if (beamEnergyMatch(4.03*GeV)) {
        book(_h_D0,2,1,1);
        book(_h_Dp,2,1,2);
      } else if (beamEnergyMatch(4.14*GeV)) {
        book(_h_D0,3,1,1);
        book(_h_Dp,3,1,2);
      } else
  ...
  DECLARE_RIVET_PLUGIN(BES_1999_I508349);
