...
YLabel=$1/\Gamma\mathrm{d} \Gamma/\mathrm{d}m^2_{\pi^+\eta^\prime}$ [$\mathrm{GeV}^{-2}$]
LogY=0
LegendXPos=0.3
END PLOT
...
XLabel=$m^2_{\pi^0\eta^\prime}$ [$\mathrm{GeV}^{-2}$]
YLabel=$1/\Gamma\mathrm{d} \Gamma/\mathrm{d}m^2_{\pi^0\eta^\prime}$ [$\mathrm{GeV}^{-2}$]
LogY=0
LegendXPos=0.3
END PLOT
