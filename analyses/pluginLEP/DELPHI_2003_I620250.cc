...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      int offset2 = -1;
      if      (beamEnergyMatch(45*GeV)) offset = 1;
      else if (beamEnergyMatch(66*GeV)) offset = 2;
      else if (beamEnergyMatch(76*GeV)) offset = 3;
      ...
      else if (beamEnergyMatch(192*GeV)) {
        offset2= 0;
        offset = 3;
      }
      else if (beamEnergyMatch(196*GeV)) {
        offset2= 0;
        offset = 4;
      }
      else if (beamEnergyMatch(200*GeV)) {
        offset2= 1;
        offset = 1;
      }
      else if (beamEnergyMatch(202*GeV)) {
        offset2= 1;
        offset = 2;
      }
      else if (beamEnergyMatch(205*GeV)) {
        offset2= 1;
        offset = 3;
      }
      else if (beamEnergyMatch(207*GeV)) {
        offset2= 1;
        offset = 4;
      }
