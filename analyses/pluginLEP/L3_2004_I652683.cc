...
namespace Rivet {
  ...
  public:
    ...
    void finalize() {
      scale(_h_Thrust_udsc, 1/ *_sumW_udsc);
      scale(_h_heavyJetmass_udsc, 1/ *_sumW_udsc);
      scale(_h_totalJetbroad_udsc, 1/ *_sumW_udsc);
      scale(_h_wideJetbroad_udsc, 1/ *_sumW_udsc);
      scale(_h_Cparameter_udsc, 1/ *_sumW_udsc);
      scale(_h_Dparameter_udsc, 1/ *_sumW_udsc);
      scale(_h_Thrust_bottom,  1./ *_sumW_b);
      scale(_h_heavyJetmass_bottom,  1./ *_sumW_b);
      scale(_h_totalJetbroad_bottom,  1./ *_sumW_b);
      scale(_h_wideJetbroad_bottom,  1./ *_sumW_b);
      scale(_h_Cparameter_bottom,  1./ *_sumW_b);
      scale(_h_Dparameter_bottom, 1./ *_sumW_b);
