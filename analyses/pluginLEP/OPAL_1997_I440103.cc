...
namespace Rivet {
  ...
  public:
    ...
    /// Constructor
    DEFAULT_RIVET_ANALYSIS_CTOR(OPAL_1997_I440103);
    ...
    void init() {
      ...
      book(_h_phi_beta2  , "/TMP/beta_phi", 20, 0.,0.5*M_PI );
      book(_h_phi_beta3  , "/TMP/beta_phi", 20, 0.,0.5*M_PI );
      book(_h_phi_beta4  , "/TMP/beta_phi", 20, 0.,0.5*M_PI );
      book(_c_phi_cos_plus , "/TMP/c_phi_cos_plus");
      book(_c_phi_cos_neg  , "/TMP/c_phi_cos_neg" );
      book(_c_phi_sin_plus , "/TMP/c_phi_sin_plus");
      book(_c_phi_sin_neg  , "/TMP/c_phi_sin_neg" );
      book(_c_phi_cos_plus2, "/TMP/c_phi_cos_plus");
      book(_c_phi_cos_neg2 , "/TMP/c_phi_cos_neg" );
      book(_c_phi_sin_plus2, "/TMP/c_phi_sin_plus");
      book(_c_phi_sin_neg2 , "/TMP/c_phi_sin_neg" );
      book(_c_phi_cos_plus3, "/TMP/c_phi_cos_plus");
      book(_c_phi_cos_neg3 , "/TMP/c_phi_cos_neg" );
      book(_c_phi_sin_plus3, "/TMP/c_phi_sin_plus");
      book(_c_phi_sin_neg3 , "/TMP/c_phi_sin_neg" );
      // D*
  ...
  DECLARE_RIVET_PLUGIN(OPAL_1997_I440103);
