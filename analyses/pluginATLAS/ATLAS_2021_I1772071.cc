...
namespace Rivet {
  ...
  class ATLAS_2021_I1772071 : public Analysis {
  public:

    // Constructor
    DEFAULT_RIVET_ANALYSIS_CTOR(ATLAS_2021_I1772071);
    ...
    void init() {
      ...
      vector<string> observables = {"ETGamma", "pTjet", "RapJet","DeltaRapGammaJet", 
                                    "DeltaPhiGammaJet","MassJetJet", "DeltaPhiJetJet", 
                                    "DeltaRapJetJet", "MassGammaJetJet"};
  ...
  DECLARE_RIVET_PLUGIN(ATLAS_2021_I1772071);
