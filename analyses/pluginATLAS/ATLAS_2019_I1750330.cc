...
namespace Rivet {
  ...
  class ATLAS_2019_I1750330 : public Analysis {
    public:
      ...
      DEFAULT_RIVET_ANALYSIS_CTOR(ATLAS_2019_I1750330);
      
      void init() {

        bool _doBoosted = true, _doResolved = true;
      ...
      void Boosted_selection(const Event& event) {
        ...
        ifilter_select(sortByPt(TrimmedJets), trim_selection);
  ...
  DECLARE_RIVET_PLUGIN(ATLAS_2019_I1750330);
}
