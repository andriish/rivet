...
Title=$H_T$ for events with $N_\mathrm{jet} \geq 2$ ($R=0.4$)
XLabel=$H_T$ [GeV]
YLabel=$\mathrm{d}\sigma(N_\mathrm{jet} \geq 2) / \mathrm{d}H_T$ [pb/GeV]
# END PLOT

# BEGIN PLOT /ATLAS_2011_S9128077/d08-x01-y01
Title=$H_T$ for events with $N_\mathrm{jet} \geq 3$ ($R=0.4$)
XLabel=$H_T$ [GeV]
YLabel=$\mathrm{d}\sigma(N_\mathrm{jet} \geq 3) / \mathrm{d}H_T$ [pb/GeV]
# END PLOT

# BEGIN PLOT /ATLAS_2011_S9128077/d09-x01-y01
Title=$H_T$ for events with $N_\mathrm{jet} \geq 4$ ($R=0.4$)
XLabel=$H_T$ [GeV]
YLabel=$\mathrm{d}\sigma(N_\mathrm{jet} \geq 4) / \mathrm{d}H_T$ [pb/GeV]
# END PLOT
