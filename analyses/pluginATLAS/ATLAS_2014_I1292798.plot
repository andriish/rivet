...
YLabel =$\mathrm{Br}(\chi_{c1}\to\gamma J/\psi)\mathrm{Br}(J/\psi\to\mu^+\mu_^-)\mathrm{d}\sigma/\mathrm{d}p_\perp$ [pb/GeV]
END PLOT

BEGIN PLOT /ATLAS_2014_I1292798/d02-x01-y01
Title=Prompt $\chi_{c2}\to\gamma J/\psi$ production as function of J/$\psi$ $p_\perp$
XLabel=$p_\perp^{J/\psi}$ [GeV]
YLabel =$\mathrm{Br}(\chi_{c2}\to\gamma J/\psi)\mathrm{Br}(J/\psi\to\mu^+\mu_^-)\mathrm{d}\sigma/\mathrm{d}p_\perp$ [pb/GeV]
END PLOT
