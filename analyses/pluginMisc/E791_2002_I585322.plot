...
Title=Lower $K^0_S\pi^+$ mass distribution in $D^+\to K^-\pi^+\pi^+$
...
Title=Higher $K^0_S\pi^+$ mass distribution in $D^+\to K^-\pi^+\pi^+$
XLabel=$m^2_{K^0_S\pi^+}$ [$\mathrm{GeV}^{-2}$]
YLabel=$1/\Gamma\mathrm{d} \Gamma/\mathrm{d}m^2_{K^0_S\pi^+}$ [$\mathrm{GeV}^{-2}$]
LogY=0
END PLOT
...
ZLabel=$1/\Gamma{\rm d}^2 \Gamma/{\rm d}m^2_{\K_S^0\pi^+}/{\rm d}m^2_{\K_S^0\pi^+}$ [$\rm{GeV}^{-4}$]
LogY=0
END PLOT
