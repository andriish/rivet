...
Title=$N_\mathrm{ch}$ (toward) for min-bias
...
Title=$N_\mathrm{ch}$ (transverse) for min-bias
XLabel=$p_\perp^\mathrm{lead}$ / GeV
YLabel=$N_\mathrm{ch}$
LogY=0
# END PLOT
...
Title=$N_\mathrm{ch}$ (away) for min-bias
XLabel=$p_\perp^\mathrm{lead}$ / GeV
YLabel=$N_\mathrm{ch}$
LogY=0
# END PLOT
...
Title=$p_\perp$ distribution (transverse, $p_\perp^\mathrm{lead} > 30 \mathrm{GeV}$)
XLabel=$p_\perp$ / GeV
YLabel=$1/\sigma \, \mathrm{d}{\sigma}/\mathrm{d}{p_\perp}$
FullRange=1
# END PLOT
