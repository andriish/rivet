...
XLabel=$\Delta R(\mathrm{h, 1st jet})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta R(\mathrm{h, 1st jet})$ [pb]
# END PLOT

# BEGIN PLOT /MC_HJETS/H_jet1_deta
Title=
XLabel=$\Delta{\eta}(\mathrm{h, 1st jet})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta{\eta}(\mathrm{h, 1st jet})$ [pb]
# END PLOT
