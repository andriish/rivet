...
XLabel=$\Delta R(\mathrm{ZZ, 1st jet})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta R(\mathrm{ZZ, 1st jet})$ [pb]
LegendXPos=0.35
LegendYPos=0.5
# END PLOT
...
Title=
XLabel=$\Delta{\eta}(\mathrm{ZZ, 1st jet})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta{\eta}(\mathrm{ZZ, 1st jet})$ [pb]
# END PLOT
...
XLabel=$\log_{10}(d_{\mathrm{cut}}/\mathrm{GeV})$
YLabel=$R_{0}$
Rebin=2
LegendYPos=0.8
LegendXPos=0.75
