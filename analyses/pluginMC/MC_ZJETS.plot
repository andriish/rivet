...
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta R(\mathrm{Z, 1st jet})$ [pb]
LegendXPos=0.35
LegendYPos=0.5
# END PLOT
...
Title=
XLabel=$\Delta{\eta}(\mathrm{Z, 1st jet})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta{\eta}(\mathrm{Z, 1st jet})$ [pb]
# END PLOT
