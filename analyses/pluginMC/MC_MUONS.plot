# BEGIN PLOT /MC_MUONS/muons_dR_
Title=$\Delta R$ separation between muons
LegendXPos=0.10
LegendYPos=0.5
# END PLOT
...
Title=Pseudorapidity of leading muon
XLabel=$\eta(\mu\mathrm{1})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\eta(\mu\mathrm{1})$ [pb]
LegendYPos=0.5
LegendXPos=0.30
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_eta_2
Title=Pseudorapidity of second muon
XLabel=$\eta(\mu\mathrm{2})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\eta(\mu\mathrm{2})$ [pb]
LegendYPos=0.5
LegendXPos=0.30
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_eta_3
Title=Pseudorapidity of third muon
XLabel=$\eta(\mu\mathrm{3})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\eta(\mu\mathrm{3})$ [pb]
LegendYPos=0.5
LegendXPos=0.30
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_eta_4
Title=Pseudorapidity of fourth muon
XLabel=$\eta(\mu\mathrm{4})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\eta(\mu\mathrm{4})$ [pb]
LegendYPos=0.5
LegendXPos=0.30
# END PLOT
...
XLabel=$|\eta(\mu\mathrm{1}|$
YLabel=$\eta(\mu\mathrm{1})_+/\eta(\mu\mathrm{1})_-$
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_eta_pmratio_2
Title=Pseudorapidity $+/-$ ratio of second muon
XLabel=$|\eta(\mu\mathrm{2}|$
YLabel=$\eta(\mu\mathrm{2})_+/\eta(\mu\mathrm{2})_-$
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_eta_pmratio_3
Title=Pseudorapidity $+/-$ ratio of third muon
XLabel=$|\eta(\mu\mathrm{3}|$
YLabel=$\eta(\mu\mathrm{3})_+/\eta(\mu\mathrm{3})_-$ 
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_eta_pmratio_4
Title=Pseudorapidity $+/-$ ratio of fourth muon
XLabel=$|\eta(\mu\mathrm{4}|$
YLabel=$\eta(\mu\mathrm{4})_+/\eta(\mu\mathrm{4})_-$
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_y_1
Title=Rapidity of first muon
XLabel=$y(\mu\mathrm{1})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}y(\mu\mathrm{1})$ [pb]
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_y_2
Title=Rapidity of second muon
XLabel=$y(\mu\mathrm{2})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}y(\mu\mathrm{2})$ [pb]
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_y_3
Title=Rapidity of third muon
XLabel=$y(\mu\mathrm{3})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}y(\mu\mathrm{3})$ [pb]
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_y_4
Title=Rapidity of fourth muon
XLabel=$y(\mu\mathrm{4})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}y(\mu\mathrm{4})$ [pb]
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_y_pmratio_1
Title=Rapidity $+/-$ ratio of first muon
XLabel=$|y(\mu\mathrm{1}|$
YLabel=$y(\mu\mathrm{1})_+/y(\mu\mathrm{1})_-$
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_y_pmratio_2
Title=Rapidity $+/-$ ratio of second muon
XLabel=$|y(\mu\mathrm{2}|$
YLabel=$y(\mu\mathrm{2})_+/y(\mu\mathrm{2})_-$
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_y_pmratio_3
Title=Rapidity $+/-$ ratio of third muon
XLabel=$|y(\mu\mathrm{3}|$
YLabel=$y(\mu\mathrm{3})_+/y(\mu\mathrm{3})_-$
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_y_pmratio_4
Title=Rapidity $+/-$ ratio of fourth muon
XLabel=$|y(\mu\mathrm{4}|$
YLabel=$y(\mu\mathrm{4})_+/y(\mu\mathrm{4})_-$
# END PLOT

# BEGIN PLOT /MC_MUONS/muon_multi_exclusive
Title=Exclusive muon multiplicity
XLabel=$N_{\mathrm{muon}}$
YLabel=$\sigma(N_{\mathrm{muon}})$ [pb]
XMajorTickMarks=10
XMinorTickMarks=0
ErrorBands=1
# END PLOT
...
Title=Inclusive muon multiplicity
XLabel=$N_{\mathrm{muon}}$
YLabel=$\sigma(\geq N_{\mathrm{muon}})$ [pb]
XMajorTickMarks=10
XMinorTickMarks=0
ErrorBands=1
# END PLOT
...
XLabel=$N_{\mathrm{muon}}$
YLabel=$\sigma(\geq N_{\mathrm{muon}})/\sigma(\geq N_{\mathrm{muon}}-1)$
XMajorTickMarks=10
XMinorTickMarks=0
LogY=0
ErrorBands=1
...
Title=Transverse momentum of leading muon
XLabel=$p_\perp(\mu\mathrm{1})$ [GeV]
YLabel=$\mathrm{d}\sigma/\mathrm{d}p_\perp(\mu\mathrm{1}$ [pb/GeV]
LogX=1
LegendXPos=0.05
LegendYPos=0.5
XMin=20.0
...
Title=Transverse momentum of second muon
XLabel=$p_\perp(\mu\mathrm{2})$ [GeV]
YLabel=$\mathrm{d}\sigma/\mathrm{d}p_\perp(\mu\mathrm{2})$ [pb/GeV]
LogX=1
LegendXPos=0.05
LegendYPos=0.5
XMin=20.0
...
Title=Transverse momentum of third muon
XLabel=$p_\perp(\mu\mathrm{3})$ [GeV]
YLabel=$\mathrm{d}\sigma/\mathrm{d}p_\perp(\mu\mathrm{3})$ [pb/GeV]
LogX=1
LegendXPos=0.05
LegendYPos=0.5
XMin=20.0
...
Title=Transverse momentum of fourth muon
XLabel=$p_\perp(\mu\mathrm{4})$ [GeV]
YLabel=$\mathrm{d}\sigma/\mathrm{d}p_\perp(\mu\mathrm{4})$ [pb/GeV]
LogX=1
LegendXPos=0.05
LegendYPos=0.5
XMin=20.0
