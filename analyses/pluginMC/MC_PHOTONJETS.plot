...
Title=
XLabel=$\Delta R(\gamma\mathrm{, 1st jet})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta R(\gamma\mathrm{, 1st jet})$ [pb]
# END PLOT

# BEGIN PLOT /MC_PHOTONJETS/photon_jet1_deta
Title=
XLabel=$\Delta{\eta}(\gamma\mathrm{, 1st jet})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta{\eta}(\gamma\mathrm{, 1st jet})$ [pb]
# END PLOT

# BEGIN PLOT /MC_PHOTONJETS/photon_jet1_dphi
Title=
XLabel=$\Delta{\phi}(\gamma\mathrm{, 1st jet})$
YLabel=$\mathrm{d}\sigma/\mathrm{d}\Delta{\phi}(\gamma\mathrm{, 1st jet})$ [pb]
# END PLOT
...
XLabel=$HT$ [GeV]
YLabel=$\mathrm{d}\sigma/\mathrm{d}HT$ [pb/GeV]
LogX=1
# END PLOT
