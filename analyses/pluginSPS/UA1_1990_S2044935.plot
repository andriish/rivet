...
XLabel=$n_\mathrm{ch}$
YLabel=$\mathrm{d}\sigma/\mathrm{d}{ n_\mathrm{ch}}$ [mb]
# END PLOT
...
Title=$E \, \mathrm{d}^3\sigma/\mathrm{d}p^3$ at $\eta=0$, $\sqrt{s} = \unit{900}{\GeV}$ ($\mathrm{d}n_\mathrm{ch}/\mathrm{d}\eta = 0.8 \dots 4$)
XLabel=$p_\perp$ [GeV]
YLabel=$E \mathrm{d}^3\sigma/\mathrm{d}p^3$ [\micro\barn\,\rpsquare\GeV]
# END PLOT

# BEGIN PLOT /UA1_1990_S2044935/d04-x01-y01
Title=$E \, \mathrm{d}^3\sigma/\mathrm{d}p^3$ at $\eta=0$, $\sqrt{s} = \unit{900}{\GeV}$ ($\mathrm{d}n_\mathrm{ch}/\mathrm{d}\eta = 4 \dots 8$)
XLabel=$p_\perp$ [GeV]
YLabel=$E \mathrm{d}^3\sigma/\mathrm{d}p^3$ [\micro\barn\,\rpsquare\GeV]
# END PLOT

# BEGIN PLOT /UA1_1990_S2044935/d05-x01-y01
Title=$E \, \mathrm{d}^3\sigma/\mathrm{d}p^3$ at $\eta=0$, $\sqrt{s} = \unit{900}{\GeV}$ ($\mathrm{d}n_\mathrm{ch}/\mathrm{d}\eta > 8$)
XLabel=$p_\perp$ [GeV]
YLabel=$E \mathrm{d}^3\sigma/\mathrm{d}p^3$ [\micro\barn\,\rpsquare\GeV]
# END PLOT

# BEGIN PLOT /UA1_1990_S2044935/d06-x01-y01
Title=$\langle p_\perp \rangle$ vs. $n_\mathrm{ch}$ at $\sqrt{s} = \unit{200}{\GeV}$
XLabel=$n_\mathrm{ch}$
YLabel=$\langle p_\perp \rangle$ [GeV]
# END PLOT

# BEGIN PLOT /UA1_1990_S2044935/d07-x01-y01
Title=$\langle p_\perp \rangle$ vs. $n_\mathrm{ch}$ at $\sqrt{s} = \unit{900}{\GeV}$
XLabel=$n_\mathrm{ch}$
YLabel=$\langle p_\perp \rangle$ [GeV]
# END PLOT

# BEGIN PLOT /UA1_1990_S2044935/d08-x01-y01
Title=$\langle p_\perp \rangle$ vs. $n_\mathrm{ch}$ at $\sqrt{s} = \unit{63}{\GeV}$
XLabel=$n_\mathrm{ch}$
YLabel=$\langle p_\perp \rangle$ [GeV]
# END PLOT
...
Title=$\langle \Sigma E_\perp \rangle$ vs. $n_\mathrm{ch}$ at $\sqrt{s} = \unit{200}{\GeV}$ and $|\eta|<2.5$
XLabel=$n_\mathrm{ch}$
YLabel=$\Sigma E_\perp$ [GeV]
# END PLOT

# BEGIN PLOT /UA1_1990_S2044935/d12-x01-y02
Title=$\langle \Sigma E_\perp \rangle$ vs. $n_\mathrm{ch}$ at $\sqrt{s} = \unit{500}{\GeV}$ and $|\eta|<2.5$
XLabel=$n_\mathrm{ch}$
YLabel=$\Sigma E_\perp$ [GeV]
# END PLOT

# BEGIN PLOT /UA1_1990_S2044935/d12-x01-y03
Title=$\langle \Sigma E_\perp \rangle$ vs. $n_\mathrm{ch}$ at $\sqrt{s} = \unit{900}{\GeV}$ and $|\eta|<2.5$
XLabel=$n_\mathrm{ch}$
YLabel=$\Sigma E_\perp$ [GeV]
# END PLOT
