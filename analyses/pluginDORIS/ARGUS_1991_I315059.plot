...
YLabel=$\text{Br}(D^0\to K^-\pi^+) s \text{d}\sigma/\text{d}x_p$ [$\text{nb}\times\text{GeV}^2$]
XLabel=$x_p$
LogY=0
END PLOT
BEGIN PLOT /ARGUS_1991_I315059/d03-x01-y01
Title=Scaled momentum spectrum for $D^\pm$ production (continuum)
YLabel=$\text{Br}(D^+\to K^-\pi^+\pi^+) s \text{d}\sigma/\text{d}x_p$ [$\text{nb}\times\text{GeV}^2$]
XLabel=$x_p$
LogY=0
END PLOT
BEGIN PLOT /ARGUS_1991_I315059/d04-x01-y01
Title=Scaled momentum spectrum for $D^{*\pm}$ production (continuum)
YLabel=$\text{Br}(D^{*+}\to D^0\pi^+)\text{Br}(D^0\to K^-\pi^+) s \text{d}\sigma/\text{d}x_p$ [$\text{nb}\times\text{GeV}^2$]
XLabel=$x_p$
LogY=0
END PLOT
...
XLabel=$p$ [GeV]
YLabel=$\text{Br}(D^0\to K^-\pi^+)/N_B\text{d}N_{D^0}/\text{d}p$ [$10^{-3}/\text{GeV}$]
LogY=0
END PLOT
BEGIN PLOT /ARGUS_1991_I315059/d06-x01-y01
Title=Momentum spectrum for $D^{\pm}$ production (B decay)
XLabel=$p$ [GeV]
YLabel=$\text{Br}(D^+\to K^-\pi^+\pi^+)/N_B\text{d}N_{D^\pm}/\text{d}p$ [$10^{-3}/\text{GeV}$]
LogY=0
END PLOT
BEGIN PLOT /ARGUS_1991_I315059/d07-x01-y01
Title=Momentum spectrum for $D^{*\pm}$ production (B decay)
XLabel=$p$ [GeV]
YLabel=$\text{Br}(D^{*+}\to D^0\pi^+)\text{Br}(D^0\to K^-\pi^+)/N_B\text{d}N_{D^{*\pm}}/\text{d}p$ [$10^{-3}/\text{GeV}$]
LogY=0
END PLOT