...
namespace Rivet {
  ...
  /// @brief tau polarization at 29 GeV
  class MAC_1987_I245571 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(MAC_1987_I245571);
  ...
  RIVET_DECLARE_PLUGIN(MAC_1987_I245571);
