...
namespace Rivet {
  ...
  public:
    ...
    void finalize() {
      ...
      normalize(_hVis_addJet1Pt); normalize(_hVis_addJet1Eta); normalize(_hVis_addJet2Pt); normalize(_hVis_addJet2Eta);
      normalize(_hVis_addJJMass); normalize(_hVis_addJJDR); normalize(_hVis_addJJHT);
      normalize(_hFull_addJet1Pt); normalize(_hFull_addJet1Eta); normalize(_hFull_addJet2Pt); normalize(_hFull_addJet2Eta);
      normalize(_hFull_addJJMass); normalize(_hFull_addJJDR); normalize(_hFull_addJJHT);
      normalize(_hVis_addBJet1Pt); normalize(_hVis_addBJet1Eta); normalize(_hVis_addBJet2Pt); normalize(_hVis_addBJet2Eta);
      normalize(_hVis_addBBMass); normalize(_hVis_addBBDR);
      normalize(_hFull_addBJet1Pt); normalize(_hFull_addBJet1Eta); normalize(_hFull_addBJet2Pt); normalize(_hFull_addBJet2Eta);
      normalize(_hFull_addBBMass); normalize(_hFull_addBBDR);

      const double xsPerWeight = ttbarXS/picobarn / sumOfWeights();
      scale(_hVis_nJet30_abs,  xsPerWeight);
      scale(_hVis_nJet60_abs,  xsPerWeight);
      scale(_hVis_nJet100_abs, xsPerWeight);
      scale(_hVis_addJet1Pt_abs,  xsPerWeight);
      scale(_hVis_addJet1Eta_abs,  xsPerWeight);
      scale(_hVis_addJet2Pt_abs,  xsPerWeight);
      scale(_hVis_addJet2Eta_abs, xsPerWeight);
      scale(_hVis_addJJMass_abs,  xsPerWeight);
      scale(_hVis_addJJDR_abs,  xsPerWeight);
      scale(_hVis_addJJHT_abs, xsPerWeight);
      scale(_hVis_addBJet1Pt_abs,  xsPerWeight);
      scale(_hVis_addBJet1Eta_abs, xsPerWeight);
      scale(_hVis_addBJet2Pt_abs,  xsPerWeight);
      scale(_hVis_addBJet2Eta_abs, xsPerWeight);
      scale(_hVis_addBBMass_abs,  xsPerWeight);
      scale(_hVis_addBBDR_abs, xsPerWeight);

      const double sfull = xsPerWeight / 0.0454; //< correct for dilepton branching fraction
      scale(_hFull_addJet1Pt_abs, sfull);
      scale(_hFull_addJet1Eta_abs,  sfull);
      scale(_hFull_addJet2Pt_abs,  sfull);
      scale(_hFull_addJet2Eta_abs, sfull);
      scale(_hFull_addJJMass_abs,  sfull);
      scale(_hFull_addJJDR_abs,  sfull);
      scale(_hFull_addJJHT_abs, sfull);
      scale(_hFull_addBJet1Pt_abs,  sfull);
      scale(_hFull_addBJet1Eta_abs,  sfull);
      scale(_hFull_addBJet2Pt_abs,  sfull);
      scale(_hFull_addBJet2Eta_abs, sfull);
      scale(_hFull_addBBMass_abs,  sfull);
