...
XLabel=$p^{\Upsilon(1S)}_{T}$ [GeV]
YLabel=Br($\Upsilon(1S) \rightarrow \mu^{+}\mu^{-}$)$\sigma\mathrm{d}^2\sigma/\mathrm{d}p_\perp\mathrm{d}y$ [fb/GeV]
END PLOT
...
Title=Non-Prompt $\Upsilon(2S)$ transverse momentum $0 < |y| < 0.6$
XLabel=$p^{\Upsilon(2S)}_{T}$ [GeV]
YLabel=Br($\Upsilon(2S) \rightarrow \mu^{+}\mu^{-}$)$\sigma\mathrm{d}^2\sigma/\mathrm{d}p_\perp\mathrm{d}y$ [fb/GeV]
END PLOT
BEGIN PLOT /CMS_2015_I1342266/d02-x01-y02
Title=Non-Prompt $\Upsilon(2S)$  transverse momentum $0.6 < |y| < 1.2$
XLabel=$p^{\Upsilon(2S)}_{T}$ [GeV]
YLabel=Br($\Upsilon(2S) \rightarrow \mu^{+}\mu^{-}$)$\sigma\mathrm{d}^2\sigma/\mathrm{d}p_\perp\mathrm{d}y$ [fb/GeV]
END PLOT
BEGIN PLOT /CMS_2015_I1342266/d03-x01-y02
Title=Non-Prompt $\Upsilon(2S)$  transverse momentum $0 < |y| < 1.2$
XLabel=$p^{\Upsilon(2S)}_{T}$ [GeV]
YLabel=Br($\Upsilon(2S) \rightarrow \mu^{+}\mu^{-}$)$\sigma\mathrm{d}^2\sigma/\mathrm{d}p_\perp\mathrm{d}y$ [fb/GeV]
END PLOT

BEGIN PLOT /CMS_2015_I1342266/d01-x01-y03
Title=Non-Prompt $\Upsilon(3S)$  transverse momentum $0 < |y| < 0.6$
XLabel=$p^{\Upsilon(3S)}_{T}$ [GeV]
YLabel=Br($\Upsilon(3S) \rightarrow \mu^{+}\mu^{-}$)$\sigma\mathrm{d}^2\sigma/\mathrm{d}p_\perp\mathrm{d}y$ [fb/GeV]
END PLOT
BEGIN PLOT /CMS_2015_I1342266/d02-x01-y03
Title=Non-Prompt $\Upsilon(3S)$  transverse momentum $0.6 < |y| < 1.2$
XLabel=$p^{\Upsilon(3S)}_{T}$ [GeV]
YLabel=Br($\Upsilon(3S) \rightarrow \mu^{+}\mu^{-}$)$\sigma\mathrm{d}^2\sigma/\mathrm{d}p_\perp\mathrm{d}y$ [fb/GeV]
END PLOT
BEGIN PLOT /CMS_2015_I1342266/d03-x01-y03
Title=Non-Prompt $\Upsilon(3S)$  transverse momentum $0 < |y| < 1.2$
XLabel=$p^{\Upsilon(3S)}_{T}$ [GeV]
YLabel=Br($\Upsilon(3S) \rightarrow \mu^{+}\mu^{-}$)$\sigma\mathrm{d}^2\sigma/\mathrm{d}p_\perp\mathrm{d}y$ [fb/GeV]
END PLOT
