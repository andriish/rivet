...
Title=$\mathrm{CMS, 8 TeV, Leading b jet transverse momentum, at least one b jet}$
XLabel=$p_{t}(b)$  GeV
...
Title=$\mathrm{CMS, 8 TeV, Leading b jet absolute pseudorapidity, at least one b jet}$
XLabel=$\eta(b)$ 
...
Title=$\mathrm{CMS, 8 TeV, Z boson pt, at least one b jet}$
XLabel=$p_{t}(Z)$ GeV
...
Title=$\mathrm{CMS, 8 TeV, HT, at least one b jet}$
XLabel=$H_{t}$ GeV
...
Title=$\mathrm{CMS, 8 TeV, DeltaPhi_Zb, at least one b jet}$
XLabel=$d\phi(Zb)$ rad
...
Title=$\mathrm{CMS, 8 TeV, Leading b jet transverse momentum, at least two b jets}$
XLabel=$p_{t}(b)$ GeV
YLabel=$d\sigma_{fiducial}/dp_{t}(b)$ pb/GeV
LogY = 1
LegendXPos=0.7
...
Title=$\mathrm{CMS, 8 TeV, Subleading b jet transverse momentum, at least two b jets}$
...
Title=$\mathrm{CMS, 8 TeV, Z boson pt, at least two b jets}$
XLabel=$p_{t}(Z)$ GeV
YLabel=$d\sigma_{fiducial}/dp_{t}(Z)$ pb/GeV
LogY=1
# END PLOT
...
Title=$\mathrm{CMS, 8 TeV, bb system mass, at least two b jets}$
XLabel=$M(bb)$ GeV
...
Title=$\mathrm{CMS, 8 TeV, Zbb system mass, at least two b jets}$
XLabel=$M(Zbb)$ GeV
...
Title=$\mathrm{CMS, 8 TeV, DeltaPhi bb, at least two b jets}$
XLabel=$d\phi(bb)$ rad
...
Title=$\mathrm{CMS, 8 TeV, DeltaR bb, at least two b jets}$
XLabel=$dR(bb)$
...
Title=$\mathrm{CMS, 8 TeV, DeltaR Zb minimum, at least two b jets}$
XLabel=$min dR(Zb)$
...
Title=$\mathrm{CMS, 8 TeV, Asymmetry dR Zb max dR Zb min , at least two b jets}$
...
Title=$\mathrm{CMS, 8 TeV, Inclusive b jet multiplicity}$
XLabel=$n_{jet}$
