      ...
      for (size_t counter = 0; counter < signal.size(); ++counter){
        ...
        if (_mode >= 0){
          const std::map<string, double> NN_Input = {
            ...
            //Lead Jet
            {"sjet_1_mv2c10_binned", tagged_constituents[0].bTagged()},
            ...
            //Second Jet
            {"sjet_2_mv2c10_binned", (nConstits > 1) ? tagged_constituents[0].bTagged() : -1. },
            ...
            //Third Jet
            {"sjet_3_mv2c10_binned", (nConstits > 2) ? tagged_constituents[0].bTagged() : -1. },
