...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      // Book histograms
      _ih=-1; _iy=-1;
      if (beamEnergyMatch(14.8*GeV)) {
        _ih=1;
      } else if (beamEnergyMatch(21.5*GeV)) {
        _ih=2;
      } else if (beamEnergyMatch(34.5*GeV)) {
        _ih=0;
        _iy=3;
      } else if (beamEnergyMatch(35.0*GeV)) {
        _ih=0;
        _iy=2;
      } else if (beamEnergyMatch(42.6*GeV)) {
        _ih=0;
        _iy=1;
      } else {
